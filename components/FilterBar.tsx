...
export function FilterBar({
  ...
  return (
    <div className="bg-white border-2 border-black rounded-lg shadow-[4px_4px_0px_0px_rgba(88,122,255,0.8)] mb-4">
      ...
      {/* Controls: Outliers Only Switch and Reset Filters Button */}
      <div className="flex justify-end items-center p-4 pt-0 space-x-4">
        {/* Outliers Only Switch */}
        ...
        <Button
          ...
          variant="outline"
          className="h-8 text-xs border border-gray-300 hover:border-[#587aff] hover:text-[#587aff] px-3"
        >
